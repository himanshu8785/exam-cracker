    ...
    return(
      ...
      <main className="min-h-screen bg-[#050816] text-white flex items-center justify-center px-4">
        ...
        <div className="w-full max-w-2xl bg-white/5 border border-white/10 backdrop-blur-xl rounded-[40px] p-8 md:p-12 text-center">
          ...
          <div className="text-6xl md:text-8xl font-black bg-gradient-to-r from-purple-400 to-blue-400 text-transparent bg-clip-text mb-10">
          ...
          <button
            ...
            className="mt-10 px-8 py-5 rounded-2xl bg-gradient-to-r from-purple-600 to-blue-600 text-lg font-bold active:scale-95 transition-all"
          >
    ...
    <main className="min-h-screen bg-[#050816] text-white px-4 md:px-6 py-10 pb-32">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-[32px] p-6 md:p-10 mb-8">
          ...
          <div className="text-sm text-purple-400 font-bold mb-5">
        ...
        <div className="flex flex-wrap justify-between gap-4">
...

          {
            ...
            <button
              ...
              className="px-8 py-4 rounded-2xl bg-gradient-to-r from-purple-600 to-blue-600 font-bold active:scale-95 transition-all"
            >
