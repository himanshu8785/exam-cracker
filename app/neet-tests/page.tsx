...
export default function NEETTestsPage(){
  ...
  const categories = [
    ...
    {
      title:"Test Series",
      desc:"Chapterwise practice tests for NEET 😎",
      icon:"🧬",
      href:"/neet-tests/test-series"
    },

    {
      title:"Subjectwise Test Series",
      desc:"Full Physics, Chemistry & Biology tests 🚀",
      icon:"📚",
      href:"/neet-tests/subjectwise"
    },

    {
      title:"Full Syllabus Test Series",
      desc:"Real NEET full syllabus mock exams 🔥",
      icon:"🏆",
      href:"/neet-tests/full-syllabus"
    }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <div className="inline-block px-5 py-3 rounded-full bg-green-500/10 border border-green-500/20 text-sm md:text-base mb-6">
            ...
            🧬 India’s Smartest NEET Mock Platform
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {categories.map((item,index)=>(
            ...
            <Link
              key={index}
              href={item.href}
              className="group relative overflow-hidden bg-white/5 border border-white/10 backdrop-blur-xl rounded-[32px] p-6 md:p-10 hover:border-green-500/50 active:scale-[0.98] hover:-translate-y-2 transition-all duration-300"
            >
              ...
              <div className="relative z-10">
                ...
                <div className="inline-flex items-center gap-2 text-green-400 font-bold text-sm md:text-lg">
